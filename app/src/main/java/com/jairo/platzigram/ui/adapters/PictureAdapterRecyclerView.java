package com.jairo.platzigram.ui.adapters;
...
import com.jairo.platzigram.ui.PictureDetail;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

/**
 * Created by Jairo on 23/02/2017.
 */
...
public class PictureAdapterRecyclerView extends RecyclerView.Adapter<PictureAdapterRecyclerView.PictureViewHolder> {
    ...
    public void onBindViewHolder(PictureViewHolder holder, int position) {
        ...
        //se trabajara con toda la lista que traigo en el arraylist
        ...
        holder.pictureCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity, PictureDetail.class);
    ...
    public int getItemCount() {
        //cuanto tiempo va a recorrer nuestro view
    ...
    public class PictureViewHolder extends RecyclerView.ViewHolder{
        ...
        public PictureViewHolder(View itemView) {
            ...
            userNameCard   = (TextView)itemView.findViewById(R.id.user_name_card);
            ...
            likeCheckCard  = (CheckBox)itemView.findViewById(R.id.like_check_card);
        }
    }
}
